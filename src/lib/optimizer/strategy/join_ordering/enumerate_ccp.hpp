...
class EnumerateCcp final {
 ...
 //private:
  ...
  void _enumerate_csg_recursive(std::vector<boost::dynamic_bitset<>>& csgs, const boost::dynamic_bitset<>& vertex_set, const boost::dynamic_bitset<>& exclusion_set);
  ...
  boost::dynamic_bitset<> _neighbourhood(const boost::dynamic_bitset<>& vertex_set, const boost::dynamic_bitset<>& exclusion_set) const;
